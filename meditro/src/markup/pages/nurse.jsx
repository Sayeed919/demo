...
const Nurse = () => {
  ...
  return (
    <div>
            ...
            <h1 style={styles.tagline}>Nurse</h1>
      {/* <h1 style={styles.tagline}>Book appointments with minimum wait-time <br/> verified nurse details</h1> */}
      <div className="nurse-list" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', marginTop: '30px' }}>
        {nursesData.map((nurse, id) => (
          <div key={nurse.id} style={{ ...styles.card, maxWidth: '300px' }}>
            <div style={styles.photoWrapper}>
              <img src={nurse.image} alt="Nurse" style={styles.photo} />
            </div>
            <div style={styles.details}>
