							...
							<div className="col-lg-4 col-sm-6 mb-30">
								<div className="work-bx">
									...
									<div className="work-content">
										<h5 className="title text-secondary mb-10">About Us</h5>
										<p>At TeleHealth-Trail, we deliver compassionate, patient-centered healthcare with expertise and integrity.</p>
									</div>
									<Link to="/about-us" className="btn btn-primary light">View More <i className="btn-icon-bx fas fa-chevron-right"></i></Link>
								</div>
							</div>
							<div className="col-lg-4 col-sm-6 mb-30">
								<div className="work-bx active">
									...
									<div className="work-content">
										...
										<p>To register or inquire, contact TeleHealth-Trail for compassionate, expert healthcare services.</p>
									</div>
									<Link to="/form-register" className="btn btn-primary light">View More <i className="btn-icon-bx fas fa-chevron-right"></i></Link>
								</div>
							</div>
							<div className="col-lg-4 col-sm-6 mb-30">
								<div className="work-bx">
									...
									<div className="work-content">
										<h5 className="title text-secondary mb-10">Contact Us</h5>
										<p>For inquiries or assistance, reach out to us at TeleHealth-Trail, where we provide compassionate and expert healthcare services.</p>
									</div>
